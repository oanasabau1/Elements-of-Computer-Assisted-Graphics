...
//
//  To apply the Cyrus-Beck algorithm to your line, press the 'c' key.
...
int main(int argc, char * argv[]) {
	...
	initClipWindow();
	std::cout << "Draw the line you want to clip with a drang-n-drop mouse action!" << "\n";
		...
		if (SDL_WaitEvent(&currentEvent) != 0)
		{
			...
			if (currentEvent.type == SDL_KEYDOWN)
			{
				...
				case SDLK_c:
					...
					if (lineClip_CyrusBeck(clipWindow, p1, p2, windowRenderer) == -1)
